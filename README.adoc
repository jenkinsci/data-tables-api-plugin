...
image:https://img.shields.io/github/release/jenkinsci/data-tables-api-plugin.svg?label=changelog[Jenkins Version, link=https://github.com/jenkinsci/data-tables-api-plugin/releases/latest]
